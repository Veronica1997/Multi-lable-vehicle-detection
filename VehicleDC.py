...
if __name__ == '__main__':
    ...
    times = 0
    frameFrequency = 1
    outPutDirName = '/home/eini/test/test_imgs/'  #路径后要加‘/’
    ...
    DR_model.detect_classify()
    # 把训练后的图片保存为视频
    filelist = os.listdir('/home/eini/test/test_result/')
    video = cv2.VideoWriter("02.mp4", cv2.VideoWriter_fourcc('m', 'p', '4', 'v'), 24, (1280, 720))

    for i in range(1, 183):
        im_name = os.path.join('/home/eini/test/test_result/',  str(i) + '.jpg')
    ...
    #for item in filelist:
            ...
            #item = '/home/eini/test/test_result/' + item
            #img = cv2.imread(item)
            #video.write(img)#
    video.release()
